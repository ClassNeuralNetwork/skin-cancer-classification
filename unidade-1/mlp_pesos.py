...
modelo = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Dense(256, activation='relu', name='oculta1'),
...
historico = modelo.fit(X_train_std, y_train, validation_split=0.2, epochs=50, batch_size=32, verbose=1, class_weight=class_weights)
